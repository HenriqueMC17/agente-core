# 16-runtime - Mapeamento de Dependências de Runtime de Alta Performance e Microserviços Edge
...
- Camada de Fundação (`01-foundation`) para garantir alinhamento das convenções sintáticas suportadas pelo runtime.
- Ferramental (`12-tooling`) para indexação e validação estrutural.
