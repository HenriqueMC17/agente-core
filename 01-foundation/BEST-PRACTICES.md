# 01-foundation - Melhores Práticas e Regras de Ouro de Fundação e Regras do Workspace

## 🚀 Boas Práticas Recomendadas

- Obediência cega ao arquivo `00-master-rules.md`.
- Uso obrigatório de TypeScript para prover tipagem estrita e evitar alucinações de tipos pelo modelo.
- Proibição absoluta de placeholders ou comentários vazios (como '// TODO: implementar').
