# 12-tooling - Matriz de Responsabilidade (RACIs) de Ferramental Interno e Scripts de Produtividade

## 🎭 Alocação de Papéis no Ciclo SDLC

- **Orchestrator Agent**: Chamar scripts automatizados de tooling para manter a integridade estrutural do repositório limpa.
- **Developer Agent**: Criar scripts determinísticos para acelerar testes, migrações e validações locais de rotina.
