# 12-tooling - Mapeamento de Dependências de Ferramental Interno e Scripts de Produtividade
...
- Camada de Execução (`06-execution-layer`) para invocar scripts físicos locais de automação.
- Módulo Core de Habilidades (`09-skills`) para manter seu catálogo devidamente indexado via scripts do tooling.
