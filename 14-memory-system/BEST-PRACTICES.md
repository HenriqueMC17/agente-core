# 14-memory-system - Melhores Práticas e Regras de Ouro de Sistema de Memória Semântica e Episódica

## 🚀 Boas Práticas Recomendadas

- Sempre buscar na base de memória vetorial por soluções semelhantes antes de iniciar o desenvolvimento 'do zero'.
- Atualizar a base vetorial com insights valiosos de engenharia obtidos após resolver bugs difíceis no projeto.
- Preservar a consistência dos índices de memória, evitando a duplicação de embeddings semânticos.
