# 00-governance - Procedimentos Operacionais e Workflows de Governança Global e Princípios de Engenharia

## 🚀 Fluxos de Trabalho Passo a Passo

- `/pm`: Validação e alinhamento de intenções estéticas no Stitch, gerando o PRD estruturado.
- `/architect`: Scaffold de decisões estruturais e criação de diagramas Mermaid de conformidade.
- Execução do script `structural-validator.ps1` antes de qualquer commit na branch Master.
