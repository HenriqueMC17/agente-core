...
|   +-- antigravity-bundle-apple-platform-design/
|   +-- antigravity-bundle-architecture-design/
|   +-- antigravity-bundle-automation-builder/
|   +-- antigravity-bundle-azure-ai-cloud/
|   +-- antigravity-bundle-business-analyst/
|   +-- antigravity-bundle-commerce-payments/
|   +-- antigravity-bundle-creative-director/
|   +-- antigravity-bundle-data-analytics/
|   +-- antigravity-bundle-data-engineering/
|   +-- antigravity-bundle-ddd-evented-architecture/
|   +-- antigravity-bundle-devops-cloud/
|   +-- antigravity-bundle-documents-presentations/
|   +-- antigravity-bundle-essentials/
|   +-- antigravity-bundle-expo-react-native/
|   +-- antigravity-bundle-full-stack-developer/
|   +-- antigravity-bundle-indie-game-dev/
|   +-- antigravity-bundle-integration-apis/
|   +-- antigravity-bundle-llm-application-developer/
|   +-- antigravity-bundle-makepad-builder/
|   +-- antigravity-bundle-marketing-growth/
|   +-- antigravity-bundle-mobile-developer/
|   +-- antigravity-bundle-observability-monitoring/
|   +-- antigravity-bundle-odoo-erp/
|   +-- antigravity-bundle-oss-maintainer/
|   +-- antigravity-bundle-python-pro/
|   +-- antigravity-bundle-qa-testing/
|   +-- antigravity-bundle-revops-crm-automation/
|   +-- antigravity-bundle-security-developer/
|   +-- antigravity-bundle-security-engineer/
|   +-- antigravity-bundle-seo-specialist/
|   +-- antigravity-bundle-startup-founder/
|   +-- antigravity-bundle-systems-programming/
|   +-- antigravity-bundle-typescript-javascript/
|   +-- antigravity-bundle-web-designer/
|   +-- antigravity-bundle-web-wizard/
