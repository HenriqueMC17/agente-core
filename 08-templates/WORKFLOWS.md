# 08-templates - Procedimentos Operacionais e Workflows de Repositório de Boilerplates e Especificações Padronizadas

## 🚀 Fluxos de Trabalho Passo a Passo

- Geração automática de ADR (Architecture Decision Record) estruturado com base em mudanças significativas de banco de dados ou APIs.
