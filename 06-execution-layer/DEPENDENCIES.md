# 06-execution-layer - Mapeamento de Dependências de Camada de Execução Local e Automação
...
- Camada de Segurança (`15-security`) para validar assinaturas e permissões de comandos locais.
