# 06-execution-layer - Procedimentos Operacionais e Workflows de Camada de Execução Local e Automação

## 🚀 Fluxos de Trabalho Passo a Passo

- Validação estrutural automática pós-geração de arquivos utilizando o script `structural-validator.ps1`.
