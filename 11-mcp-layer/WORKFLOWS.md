# 11-mcp-layer - Procedimentos Operacionais e Workflows de Camada Model Context Protocol (MCP)

## 🚀 Fluxos de Trabalho Passo a Passo

- Sincronização em tempo real de tokens estéticos do Figma/Stitch MCP para gerar dinamicamente o arquivo `DESIGN.md` do frontend.
