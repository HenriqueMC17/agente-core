# 10-rules-engine - Mapeamento de Dependências de Motor de Regras e Linters Sintáticos
...
- Fundação (`01-foundation`) para herdar as regras globais e regras do workspace.
- Camada de Execução (`06-execution-layer`) para acionar os validadores via terminal.
