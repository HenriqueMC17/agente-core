# 04-workflows - Procedimentos Operacionais e Workflows de Fluxos de Trabalho Padronizados (BMAD)

## 🚀 Fluxos de Trabalho Passo a Passo

- Ciclo completo de desenvolvimento ativado por comandos CLI: `/pm` -> `/architect` -> `/dev` -> `/qa` -> `@devops`.
