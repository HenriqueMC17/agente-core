# 09-skills - Mapeamento de Dependências de Habilidades Especializadas e Extensíveis do Agente
...
- Ferramental (`12-tooling`) para indexação semântica e auto-documentação.
- Camada de Observabilidade (`13-observability`) para avaliar a eficácia de uso de cada skill por chamada.
