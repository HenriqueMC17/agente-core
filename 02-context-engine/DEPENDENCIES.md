# 02-context-engine - Mapeamento de Dependências de Motor de Contexto e Gerenciamento de Memória Activa
...
- Módulo de Memória (`14-memory-system`) para busca e indexação semântica de aprendizados.
- Protocolo MCP (`11-mcp-layer`) para extrair contexto de sistemas externos de forma determinística.
