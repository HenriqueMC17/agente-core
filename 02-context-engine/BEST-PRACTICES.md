# 02-context-engine - Melhores Práticas e Regras de Ouro de Motor de Contexto e Gerenciamento de Memória Activa

## 🚀 Boas Práticas Recomendadas

- Aplicar a técnica de 'Cerca Elétrica' (restrições severas no prompt) para evitar derivação temática.
- Praticar a 'Divulgação Progressiva' para manter o contexto limpo e focado no problema imediato.
- Utilizar esquemas CTR-AI (Contexto, Tarefa, Referência) na estruturação de prompts.
